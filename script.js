...
const product1 = { name: 'Candle', model: 'Pinewood', cost: 11.11, quantity: 10 };
const product2 = { name: 'Plant', model: 'Pothos', cost: 22.22, quantity: 20 };
const product3 = { name: 'Frame', model: 'Gold Picture Frame', cost: 12.34, quantity: 15 };
